...
GLenum el::es2::asTextureFormat(GraphicsPixelFormat textureFormat)
{
    GLenum format = 0;
    ...
    case GraphicsPixelFormat::GraphicsPixelFormatRG8Unorm_sRGB:         format = GL_LUMINANCE_ALPHA; break;
    case GraphicsPixelFormat::GraphicsPixelFormatRG8Snorm:              format = GL_LUMINANCE_ALPHA; break;
    case GraphicsPixelFormat::GraphicsPixelFormatRG8Uint:               format = GL_LUMINANCE_ALPHA; break;
    case GraphicsPixelFormat::GraphicsPixelFormatRG8Sint:               format = GL_LUMINANCE_ALPHA; break;
