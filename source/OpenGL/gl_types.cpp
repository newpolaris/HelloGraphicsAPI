...
GLenum el::asTextureType(GraphicsPixelFormat format)
{
    ...
    case GraphicsPixelFormat::GraphicsPixelFormatRGB8Unorm:             textureType = GL_UNSIGNED_BYTE; break;
...
GLenum el::asTextureFormat(GraphicsPixelFormat textureFormat)
{
    ...
    case GraphicsPixelFormat::GraphicsPixelFormatRG8Unorm:              format = GL_LUMINANCE_ALPHA; break;
